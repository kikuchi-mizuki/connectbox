...
export const services: Service[] = [
  ...
  },
  {
    ...
    name: "既存事業ブラッシュアップ",
    en: "Business",
    path: "/connectbox/business-upgrade",
    hasLp: false,
    tagline: "次に選ばれる理由を磨く。",
    lead: "",
    heroImage:
